...
def user_vlance_preprocess():

    # Load the data
    df = pd.read_csv(f'/home/nngiaminh1812/airflow/dags/data/raw/raw_user_vlance_{date.today().strftime("%Y-%m-%d")}.csv', encoding='utf-8')
    ...
    df_applications.to_csv(f'/home/nngiaminh1812/airflow/dags/data/preprocessed/new_applications.csv_{date.today().strftime("%Y-%m-%d")}.csv', index=False)
    ...
    df_applicants.to_csv(f'home/nngiaminh1812/airflow/dags/data/preprocessed/new_applicants_{date.today().strftime("%Y-%m-%d")}.csv', index=False)

if __name__ == "__main__":
    user_vlance_preprocess()
